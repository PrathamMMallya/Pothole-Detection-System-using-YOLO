...
try:
    ...
    class_name = []
    with open(r"C:\Users\prath\Downloads\Pothole-Detection-System-using-YOLO-Tiny-v4\utils\obj.names", 'r') as f:
        class_name = [cname.strip() for cname in f.readlines()]

    net1 = cv.dnn.readNet(r"C:\Users\prath\Downloads\Pothole-Detection-System-using-YOLO-Tiny-v4\utils\yolov4_tiny.weights", r"C:\Users\prath\Downloads\Pothole-Detection-System-using-YOLO-Tiny-v4\utils\yolov4_tiny.cfg")
    net1.setPreferableBackend(cv.dnn.DNN_BACKEND_CUDA)
    net1.setPreferableTarget(cv.dnn.DNN_TARGET_CUDA_FP16)
    model1 = cv.dnn_DetectionModel(net1)
    model1.setInputParams(size=(640, 480), scale=1/255, swapRB=True)

    cap = cv.VideoCapture(r"C:\Users\prath\Downloads\Pothole-Detection-System-using-YOLO-Tiny-v4\test.mp4")
    if not cap.isOpened():
    ...
    result = cv.VideoWriter(r"C:\Users\prath\Downloads\Pothole-Detection-System-using-YOLO-Tiny-v4\result.avi", cv.VideoWriter_fourcc(*'MJPG'), 10, (int(width), int(height)))

    g = geocoder.ip('me')
    result_path = r"C:\Users\prath\Downloads\Pothole-Detection-System-using-YOLO-Tiny-v4\pothole_coordinates"
